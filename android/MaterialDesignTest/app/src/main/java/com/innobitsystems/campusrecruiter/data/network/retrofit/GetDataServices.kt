...
import com.innobitsystems.campusrecruiter.data.model.*
...
interface GetDataServices {
    ...
    fun studentForgotPassword(@Body email: ResetRequest): Single<MessageResponse>
    ...
    fun tpoForgotPassword(@Body email: ResetRequest):Single<MessageResponse>
