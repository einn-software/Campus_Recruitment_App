...
import com.innobitsystems.campusrecruiter.data.interactor.implementation.ResultRepo
                ...
                resultRepo.getStudentResultFromRemoteRepo(sessionManager.getUserAuthToken()!!,
                    ...
                    .subscribe(
                        { success ->
                            ...
                            (view!! as ExamInfo).apply {
                                studentLogout.visibility = View.VISIBLE
                                studentLogout.isEnabled = true
                            }
